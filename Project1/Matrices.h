...
public:
	// constructors
	Matrix2f() { m[0] = 0.0f; m[1] = 0.0f; m[2] = 0.0f; m[3] = 0.0f; }
	Matrix2f(const Matrix2& _m)	{
		m[0] = (float)_m[0];		m[1] = (float)_m[1];		m[2] = (float)_m[2];		m[3] = (float)_m[3];
	}
	Matrix2f& operator=(const Matrix2& _m)	{
		m[0] = (float)_m[0];		m[1] = (float)_m[1];		m[2] = (float)_m[2];		m[3] = (float)_m[3];
		return *this;
	}
...
public:
	// constructors
	Matrix3f() { 
		memset(m, 0x00, sizeof(float) * 9);
	}
	Matrix3f(const Matrix3& _m) {
		m[0] = (float)_m[0];		m[1] = (float)_m[1];		m[2] = (float)_m[2];
		m[3] = (float)_m[3];		m[4] = (float)_m[4];		m[5] = (float)_m[5];
		m[6] = (float)_m[6];		m[7] = (float)_m[7];		m[8] = (float)_m[8];
	}
	Matrix3f& operator=(const Matrix3& _m) {
		m[0] = (float)_m[0];		m[1] = (float)_m[1];		m[2] = (float)_m[2];
		m[3] = (float)_m[3];		m[4] = (float)_m[4];		m[5] = (float)_m[5];
		m[6] = (float)_m[6];		m[7] = (float)_m[7];		m[8] = (float)_m[8];
		return *this;
...
public:
	...
	Matrix4f(const Matrix4& _m) {
		m[0] = (float)_m[0];		m[1] = (float)_m[1];		m[2] = (float)_m[2];		m[3] = (float)_m[3];
		m[4] = (float)_m[4];		m[5] = (float)_m[5];		m[6] = (float)_m[6];		m[7] = (float)_m[7];
		m[8] = (float)_m[8];		m[9] = (float)_m[9];		m[10] = (float)_m[10];	m[11] = (float)_m[11];
		m[12] = (float)_m[12];	m[13] = (float)_m[13];	m[14] = (float)_m[14];	m[15] = (float)_m[15];
	}
	Matrix4f& operator=(const Matrix4& _m) {
		m[0] = (float)_m[0];		m[1] = (float)_m[1];		m[2] = (float)_m[2];		m[3] = (float)_m[3];
		m[4] = (float)_m[4];		m[5] = (float)_m[5];		m[6] = (float)_m[6];		m[7] = (float)_m[7];
		m[8] = (float)_m[8];		m[9] = (float)_m[9];		m[10] = (float)_m[10];	m[11] = (float)_m[11];
		m[12] = (float)_m[12];	m[13] = (float)_m[13];	m[14] = (float)_m[14];	m[15] = (float)_m[15];
...
inline const float* Matrix4::getf()
{
	for(int i=0;i<16;++i)
		fm[i] = (float)m[i];
	return fm;
